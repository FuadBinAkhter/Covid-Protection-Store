    ...
    <div class="container-fluid mt-3">
        <div class="row">
            <div class="col-12 col-md-1" style="text-align: center;">
                <img src="images/onlinelogomaker-031821-2357-6488-2000-transparent.png" style="height: 70px;" alt="Logo">
            </div>
        ...
        <div class="row">
            <div class="col-12 col-md-3 mt-4 mb-5">
                <div class="list-group">
                    ...
                    <a href="showUserInfo.php" class="list-group-item list-group-item-action">User Info</a>
                     <!--User Info button Added-->
            ...
            <div class="col-12 col-md-9 mt-4">
                ...
                <form method="POST">
                    ...
                    <input type="submit" class="btn btn-dark mt-5" value="Save Changes" name="">
                </form>
                ...
                <form action="" method="POST" enctype = "multipart/form-data">
						<div class = "form-group mt-4">
							<label>Name</label>
							<input type="text" name="member_name" value="" placeholder="Enter member name" class="form-control" required />
						</div>
						<div class = "form-group mt-4">
							<label>Student ID</label>
							<input type="number" name="member_std_id" value="" placeholder="Enter member student ID" class="form-control" required />
						</div>
						<div class = "form-group mt-4">
							<label>Email</label>
							<input type="email" name="member_email" value="" placeholder="Enter member email" class="form-control" required />
						</div>
						<div class = "form-group mt-4">
							<label>Facebook Profile</label>
							<input type="url" name="member_facebook" value="" placeholder="Enter member facebook profile" class="form-control" />
						</div>
						<div class = "form-group mt-4">
							<label>LinkedIn Profile</label>
							<input type="url" name="member_linkedin" value="" placeholder="Enter member linkedin profile" class="form-control" />
						</div>
						<div class = "form-group mt-4">
							<label>Twitter Profile</label>
							<input type="url" name="member_twitter" value="" placeholder="Enter member twitter profile" class="form-control" />
						</div>
						<div class = "form-group mt-4">
