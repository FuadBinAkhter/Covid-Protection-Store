  ...
  <div class="container">
    <div class="row content">
      ...
      <div class="col-md-6">
        ...
        <div class="mt-4">
          <a class="ald" href="SignUp.php">Don't have an account?</a>
        </div>
        <div class="mt-4">
          <a class="ald" name="reset" href="ResetPassword.php">Forgot Password?</a>
        </div>
        <div class="mt-4">
          <a class="ald" href="adminLogin.php">An Admin?</a>
        </div>
